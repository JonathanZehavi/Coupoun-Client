...
function CreateCouponModal() {
    ...
    const [newCoupon, setNewCoupon]: any = useState({
        title: "",
        description: "",
        startDate: "",
        endDate: "",
    ...
    const [comapnyIdError, setCompanyIdError] = useState<string>("")
    ...
    let handleSubmit = (e: any) => {
        ...
        if (newCoupon.companyId <= 0) {
            setCompanyIdError("Company ID is not valid")
            isValid = false
        }
                ...
                <div className='form-create-coupon-container'>
                    ...
                    <form className='form-create-coupon' onSubmit={handleSubmit}>
                        ...
                        <div className='details-of-coupons'>
                            ...
                            <p className='error'>{comapnyIdError}</p>
                        </div>
                        <div className='details-of-coupons'>

...
function PurchasesHistoy() {
    ...
    return (
        <div className='purchase-history-full-page'>
            {purchasesDetailsByPage.length > 0 ?
                            ...
                            return <>
                                <div className='purchase-history-card'>
                                    <div className='header-history'>
                                        <h3 className='title-purchase-details'>Order Details:</h3>
                ...
                :
                <div className='nothing-to-show-here-purchases-history-contianer'>
                    <div>Nothing to show here</div>
                    <div>It seems like you havn't made any purchases yet! what are you waiting for?</div>
                </div>
            }
